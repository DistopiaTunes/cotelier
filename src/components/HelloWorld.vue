    ...
    <section class="py-20 px-4 md:px-8">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex justify-center space-x-6">
                <a href="https://wa.me/554130492413" target="_blank" class="bg-green-500/80 hover:bg-green-600/80 text-white px-6 py-3 rounded-lg flex items-center">
                ...
                <a href="https://instagram.com/cotelier.oficial" target="_blank" class="bg-pink-600/80 hover:bg-pink-700/80 text-white px-6 py-3 rounded-lg flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://facebook.com/cotelier.oficial" target="_blank" class="bg-blue-600/80 hover:bg-blue-700/80 text-white px-6 py-3 rounded-lg flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
